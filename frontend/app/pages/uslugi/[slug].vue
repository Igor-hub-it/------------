  ...
  switch (service.value?.slug) {
    ...
    case 'nezhilaya-nedvizhimost':
      return {
        ...
        paragraphs: [
          'Оценивать стоимость нежилой недвижимости чаще всего приходится предпринимателям, так как к этой категории относятся постройки для производства и хранения товаров, торговли, отдыха, офисных задач и других целей. Наша компания «Перакс Оценка» определит реальную стоимость вашей собственности. Вы получите документ с окончательной ценой и детальным описанием всех факторов, которые на нее повлияли.',
    ...
    case 'zhilaya-nedvizhimost':
      return {
        ...
        paragraphs: [
          ...
          'Компания «Перакс Оценка» занимается оценкой недвижимого имущества с предоставлением отчета и с гарантией качества. Наши услуги могут быть полезны частным лицам и предпринимателям.',
    ...
    case 'zemelnyj-uchastok':
      return {
        ...
        paragraphs: [
          ...
          'Наша компания «Перакс Оценка» оказывает услугу оценки недвижимого имущества и выдает клиентам официальный отчет по ее результатам.',
    ...
    case 'kadastrovaya-stoimost':
      return {
        ...
        paragraphs: [
          ...
          'Предлагаем заказать эту услугу в нашей компании «Перакс Оценка». По завершению оценки недвижимого имущества вы получите отчет, соответствующий государственным требованиям.'
        ],
        bullets: [] as string[]
      }
    default:
...
const nonResidentialExtraBlocks: ServiceExtraBlock[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Наша компания «Перакс Оценка» оказывает оценочные услуги и предоставляет клиенту официальный отчет об оценке.'
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Компания «Перакс Оценка» проводит оценку нежилой недвижимости и предоставляет клиенту отчет, в котором учтены все факторы, влияющие на цену.'
    ],
