...
- `backend` — API на `FastAPI` для отправки заявок на email через SMTP
...
Перед запуском укажите в `backend/.env` настройки SMTP: `SMTP_HOST`, `SMTP_PORT`, `SMTP_USER`, `SMTP_PASSWORD`, `MAIL_FROM`, `MAIL_TO`.
